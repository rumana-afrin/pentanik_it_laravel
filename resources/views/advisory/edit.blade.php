            ...
            <div class="col-md-8 stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Edit Advisory</h5>

                        <!-- Multi Columns Form -->
                        <form class="row g-3" action="{{ route('admin.update-advisory', $advisory->id) }}" method="post"
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" name="designation" id="designation"
                                    placeholder="slug" value="{{ $advisory->designation }}">
                            </div>
                            <div class="col-12 col-sm-12 col-md-6">
                                <label for="bio" class="form-label">Biography</label>
                                <textarea class="form-control" name="bio" id="bio" placeholder="bio" cols="30" rows="3">{{ $advisory->bio }}</textarea>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" class="form-control" name="email" id="email" placeholder="email"
                                    value="{{ $advisory->email }}">
                            </div>
                            <div class="col-12 col-sm-12 col-md-6">
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <input type="number" class="form-control" name="experience_years" id="experience_years"
                                    placeholder="experience years" value="{{ $advisory->experience_years }}">
                            </div>

                            <div class="col-12 col-sm-12 col-md-6">
                                <label for="sort_order" class="form-label">Order</label>
                                <input type="number" class="form-control" name="sort_order" id="sort_order"
                                    placeholder="sort_order" value="{{ $advisory->sort_order }}">
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <div class="repeater-container">
                                    ...
                                    @if (count($advisory->advisorySkills) > 0)
                                        @foreach ($advisory->advisorySkills as $item)
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <div class="upload-img-box">
                                    <img id="updateImageUrl"
                                        src="{{ $advisory->image ? asset('storage/' . $advisory->image) : getDefaultImage() }}">
