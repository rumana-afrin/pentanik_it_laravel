            ...
            <div class="navbar-container d-flex justify-content-center align-items-center">
                <div class="navbar p-0 m-0">
                    <div class="logo text-light fs-4">
                        ...
                        <a href="{{ url('/') }}"><img class="logo-image"
                                src="{{ getimage(getOption('header_logo')) }}" alt="" width="150"
                                height="60"></a>
                    ...
                    <!--end page menu -->
                    <div class="right-nav">
                        <a href="tel:{{ getOption('contact_phone') }}"><i
                                class="fa-solid fa-phone-volume pe-2"></i>{{ getOption('contact_phone') }}</a>
                    ...
                    <div id="mySidebar" class="sidebar">
                        <div class="mlogo mb-5">
                            <a href="{{ url('/') }}">
                                <img class="mlogo-image ms-5" src="{{ getimage(getOption('footer_logo')) }}"
                        ...
                        <li class="dropdown-container">
                            <a href="#"
                                class="dropdown-togglee d-flex justify-content-between align-items-center">
