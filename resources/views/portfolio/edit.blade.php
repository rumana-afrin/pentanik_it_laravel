                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('admin.update-portfolio', $portfolio->id) }}" method="post"
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <textarea class="form-control" name="short_description" id="short_description" placeholder="short description"
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" name="client_name" id="client_name"
                                    placeholder="client name" value="{{ $portfolio->client_name }}">
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <input type="number" class="form-control" name="sort_order" id="sort_order"
                                    placeholder="sort order" value="{{ $portfolio->sort_order }}">
                            </div>

                            <div class="col-12 col-sm-12 col-md-6">
                                <label for="project_url" class="form-label">Project Url</label>
                                <input type="url" class="form-control" name="project_url" id="project_url"
                                    placeholder="client project url" value="{{ $portfolio->project_url }}">
                            </div>
                            <div class="col-12 col-sm-12 col-md-6">
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" name="meta_title" id="meta_title"
                                    placeholder="meta title" value="{{ $portfolio->seoMetaTag?->meta_title }}">
                            </div>
                            <div class="col-12 col-sm-12 col-md-6">
                                <label for="meta_description" class="form-label">Meta Description</label>
                                <input type="text" class="form-control" name="meta_description" id="meta_description"
                                    placeholder="meta description" value="{{ $portfolio->seoMetaTag?->meta_description }}">
                            </div>
                            <div class="col-12 col-sm-12 col-md-6">
                                <label for="meta_keywords" class="form-label">Meta Keywords</label>
                                <input type="text" class="form-control" name="meta_keywords" id="meta_keywords"
                                    placeholder="meta keywords" value="{{ $portfolio->seoMetaTag?->meta_keywords }}">
                            </div>
                              <div class="col-12 col-sm-12 col-md-6">
                                <label for="auther" class="form-label">Site Auther</label>
                                <input type="text" class="form-control" name="auther" id="auther"
                                    placeholder="auther" value="{{ $portfolio->seoMetaTag?->auther }}">
                            </div>
                            {{-- <div class="col-12 col-sm-12 col-md-6">
                                <label for="canonical_url" class="form-label">Canonical Url</label>
                                <input type="url" class="form-control" name="canonical_url" id="canonical_url"
                                    placeholder="canonical url" value="{{ $portfolio->seoMetaTag?->canonical_url }}">
                            </div> --}}
                            <div class="col-12 col-sm-12 col-md-6">
                                <label for="og_title" class="form-label">Og Title</label>
                                <input type="text" class="form-control" name="og_title" id="og_title"
                                    placeholder="open graph  title" value="{{ $portfolio->seoMetaTag?->og_title }}">
                            </div>
                            <div class="col-12 col-sm-12 col-md-6">
                                <label for="og_description" class="form-label">Og Description</label>
                                <textarea class="form-control" id="og_description" name="og_description"
                                        placeholder="open graph  description" cols="30" rows="3">{{ $portfolio->seoMetaTag?->og_description }}</textarea>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <div class="upload-img-box">
                                    <img id="updateImageUrl"
                                        src="{{ $portfolio->seoMetaTag?->og_image ? asset('storage/' . $portfolio->seoMetaTag?->og_image) : getDefaultImage() }}">
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" name="og_type" id="og_type"
                                    placeholder="open graph type" value="{{ $portfolio->seoMetaTag?->og_type }}">
                            </div>
{{--                             
                             <div class="col-12 col-sm-12 col-md-6">
                                <label for="og_url" class="form-label">Og URl</label>
                                <input type="url" class="form-control" name="og_url" id="og_url"
                                    placeholder="og url" value="{{ $portfolio->seoMetaTag?->og_url }}">
                            </div> --}}
                             <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" name="og_site_name" id="og_site_name"
                                    placeholder="open graph  site name" value="{{ $portfolio->seoMetaTag?->og_site_name }}">
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" name="twitter_card" id="twitter_card"
                                    placeholder="twitter card" value="{{ $portfolio->seoMetaTag?->twitter_card }}">
                            </div>
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" name="twitter_title" id="twitter_title"
                                    placeholder="twitter title" value="{{ $portfolio->seoMetaTag?->twitter_title }}">
                            </div>
                            <div class="col-12 col-sm-12 col-md-6">
                                <label for="twitter_description" class="form-label">Twitter Description</label>
                                    <textarea class="form-control" id="twitter_description" name="twitter_description"
                                        placeholder="twitter description" cols="30" rows="3">{{ $portfolio->seoMetaTag?->twitter_description }}</textarea>
                            </div>
                               <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" name="twitter_site" id="twitter_site"
                                    placeholder="@/yourtwitterhandle" value="{{ $portfolio->seoMetaTag?->twitter_site }}">
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                ...
                                <div class="upload-img-box">
                                    <img id="updateImageUrl"
                                        src="{{ $portfolio->seoMetaTag?->twitter_image ? asset('storage/' . $portfolio->seoMetaTag?->twitter_image) : getDefaultImage() }}">
